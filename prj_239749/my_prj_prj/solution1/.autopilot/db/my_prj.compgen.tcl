...
set id 107
set name my_prj_mul_mul_18s_11ns_28_1_1
...
set out_width 28
set exp i0*i1
set arg_lists {i0 {18 1 +} i1 {11 0 +} p {28 1 +} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { tree_scores_V_address0 { O 2 vector } tree_scores_V_ce0 { O 1 bit } tree_scores_V_we0 { O 1 bit } tree_scores_V_d0 { O 18 vector } tree_scores_V_address1 { O 2 vector } tree_scores_V_ce1 { O 1 bit } tree_scores_V_we1 { O 1 bit } tree_scores_V_d1 { O 18 vector } } \
} "
} else {
